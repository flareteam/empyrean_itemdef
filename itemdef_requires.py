...
requires1.insert(ItemType.MELEE_HEAD,      ("defense",  7, 3, 5))
requires1.insert(ItemType.RANGED_HEAD,     ("defense",  6, 3, 5))
requires1.insert(ItemType.MENT_HEAD,       ("defense",  5, 3, 5))
requires1.insert(ItemType.MELEE_CHEST,     ("defense",  4, 3, 4))
requires1.insert(ItemType.RANGED_CHEST,    ("defense",  3, 3, 4))
requires1.insert(ItemType.MENT_CHEST,      ("defense",  2, 3, 4))
requires1.insert(ItemType.MELEE_LEGS,      ("defense",  4, 3, 4))
requires1.insert(ItemType.RANGED_LEGS,     ("defense",  3, 3, 4))
requires1.insert(ItemType.MENT_LEGS,       ("defense",  2, 3, 4))
requires1.insert(ItemType.MELEE_FEET,      ("defense",  4, 3, 4))
requires1.insert(ItemType.RANGED_FEET,     ("defense",  3, 3, 4))
requires1.insert(ItemType.MENT_FEET,       ("defense",  2, 3, 4))
requires1.insert(ItemType.MELEE_HANDS,     ("defense",  4, 3, 4))
requires1.insert(ItemType.RANGED_HANDS,    ("defense",  3, 3, 4))
requires1.insert(ItemType.MENT_HANDS,      ("defense",  2, 3, 4))
requires1.insert(ItemType.MELEE_ARTIFACT,  ("defense",  4, 3, 4))
requires1.insert(ItemType.RANGED_ARTIFACT, ("defense",  3, 3, 4))
requires1.insert(ItemType.MENT_ARTIFACT,   ("defense",  2, 3, 4))
requires1.insert(ItemType.MELEE_WEAPON,    ("physical", 2, 3, 2))
requires1.insert(ItemType.RANGED_WEAPON,   ("offense",  2, 3, 2))
requires1.insert(ItemType.MENT_WEAPON,     ("mental",   2, 3, 2))
requires1.insert(ItemType.SHIELD,          ("defense",  3, 3, 3))
