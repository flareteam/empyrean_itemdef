...
bonus1.insert(ItemType.RANGED_HEAD,     ("accuracy",         1, 6))
bonus1.insert(ItemType.MENT_HEAD,       ("mp",               3, 6))
bonus1.insert(ItemType.MELEE_CHEST,     ("hp",              25, 2))
bonus1.insert(ItemType.RANGED_CHEST,    ("accuracy",         1, 2))
bonus1.insert(ItemType.MENT_CHEST,      ("mp",               3, 2))
bonus1.insert(ItemType.MELEE_LEGS,      ("poise",            2, 2))
bonus1.insert(ItemType.RANGED_LEGS,     ("avoidance",        1, 2))
bonus1.insert(ItemType.MENT_LEGS,       ("mp",               2, 2))
bonus1.insert(ItemType.MELEE_FEET,      ("poise",            1, 2))
bonus1.insert(ItemType.RANGED_FEET,     ("avoidance",        2, 2))
...
bonus1.insert(ItemType.RANGED_ARTIFACT, ("avoidance",        1, 2))
